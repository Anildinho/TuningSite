...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronz4">
    <div class="container">
        <h1 class="display-4 h1Class">BMW Z4M40i sDrive Roadster </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/Z-modellen/bmw_z4_variants_overview.php" class="linkDecorationNone">Z4</a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">Z4M40i sDrive Roadster</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">Z4M40i sDrive</p>
                            <p class="card-text pClass marginBottomLink">Roadster</p>
