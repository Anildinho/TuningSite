...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronz4">
    <div class="container">
        <h1 class="display-4 h1Class">BMW Z4 sDrive 30i Roadster </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">Z4 sDrive 30i Roadster</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">Z4 sDrive 30i</p>
                            <p class="card-text pClass marginBottomLink">Roadster</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">258 pk</p>
                            ...
                            <p class="card-text pClass marginBottomLink">5.4 sec</p>
                        </div>
                    </div>
                </div>
            </div>
