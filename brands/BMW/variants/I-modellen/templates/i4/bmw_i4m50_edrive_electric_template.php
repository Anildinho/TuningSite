...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotroni4">
    <div class="container">
        <h1 class="display-4 h1Class"><?= $brand ?> <?= $model ?> M50</h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite"><?= $model ?> M50</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink"><?= $model ?> M50</p>
                            <p class="card-text pClass marginBottomLink">Gran Coupe</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">544 pk</p>
                            <p class="card-text pClass marginBottomLink">795 nm</p>
                            ...
                            <p class="card-text pClass marginBottomLink">225 km/u</p>
                            <p class="card-text pClass marginBottomLink">3.9 sec</p>
                        </div>
                    </div>
                </div>
            </div>
