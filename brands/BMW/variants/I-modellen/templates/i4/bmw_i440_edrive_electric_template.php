...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotroni4">
    <div class="container">
        <h1 class="display-4 h1Class"><?= $brand ?> <?= $model ?> eDrive 40 </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/bmw_overview.php" class="linkDecorationNone"><?= $brand ?></a></li>
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/I-modellen/bmw_i4_variants_overview.php" class="linkDecorationNone"><?= $model ?></a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite"><?= $model ?> eDrive 40</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">Accucapaciteit:</p>
                            <p class="card-text pClass marginBottomLink">Voeding:</p>
                        ...
                        <div class="col-sm-6">
                            <p class="card-text pClass marginBottomLink"><?= $brand ?></p>
                            <p class="card-text pClass marginBottomLink"><?= $model ?> eDrive 40</p>
                            <p class="card-text pClass marginBottomLink">Gran Coupe</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">340 pk</p>
                            <p class="card-text pClass marginBottomLink">430 nm</p>
                            <p class="card-text pClass marginBottomLink">80.7 kWh</p>
                            <p class="card-text pClass marginBottomLink">Electriciteit</p>
                            <p class="card-text pClass marginBottomLink">Automaat</p>
                            <p class="card-text pClass marginBottomLink">4/5 deuren</p>
                            <p class="card-text pClass marginBottomLink">190 km/u</p>
                            <p class="card-text pClass marginBottomLink">5.7 sec</p>
                        </div>
                    </div>
                </div>
            </div>
