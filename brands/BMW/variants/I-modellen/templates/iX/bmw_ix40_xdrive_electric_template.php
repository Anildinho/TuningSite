...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotroniX">
    <div class="container">
        <h1 class="display-4 h1Class"><?= $brand ?> <?= $model ?> xDrive 40</h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite"><?= $model ?> xDrive 40</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink"><?= $model ?> xDrive 40</p>
                            <p class="card-text pClass marginBottomLink">SUV</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">326 pk</p>
                            <p class="card-text pClass marginBottomLink">630 nm</p>
                            <p class="card-text pClass marginBottomLink">71.0 kWh</p>
                            ...
                            <p class="card-text pClass marginBottomLink">6.1 sec</p>
                        </div>
                    </div>
                </div>
            </div>
