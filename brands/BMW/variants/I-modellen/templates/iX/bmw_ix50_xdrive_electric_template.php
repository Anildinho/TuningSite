...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotroniX">
    <div class="container">
        <h1 class="display-4 h1Class"><?= $brand ?> <?= $model ?> xDrive 50</h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/I-modellen/bmw_iX_variants_overview.php" class="linkDecorationNone"><?= $model ?></a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite"><?= $model ?> xDrive 50</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink"><?= $model ?> xDrive 50</p>
                            <p class="card-text pClass marginBottomLink">SUV</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">523 pk</p>
                            <p class="card-text pClass marginBottomLink">765 nm</p>
                            <p class="card-text pClass marginBottomLink">105.2 kWh</p>
                            ...
                            <p class="card-text pClass marginBottomLink">200 km/u</p>
                            <p class="card-text pClass marginBottomLink">4.6 sec</p>
                        </div>
                    </div>
                </div>
            </div>
