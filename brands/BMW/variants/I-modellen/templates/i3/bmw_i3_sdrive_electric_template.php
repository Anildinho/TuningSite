...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotroni3">
    <div class="container">
        <h1 class="display-4 h1Class"><?= $brand ?> <?= $model ?> (120Ah) </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/I-modellen/bmw_i3_variants_overview.php" class="linkDecorationNone"><?= $model ?></a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite"><?= $model ?> (120Ah)</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink"><?= $model ?> (120Ah)</p>
                            <p class="card-text pClass marginBottomLink">Hatchback</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">170 pk</p>
                            <p class="card-text pClass marginBottomLink">250 nm</p>
                            <p class="card-text pClass marginBottomLink">42.2 kWh</p>
                            ...
                            <p class="card-text pClass marginBottomLink">150 km/u</p>
                            <p class="card-text pClass marginBottomLink">7.3 sec</p>
                        </div>
                    </div>
                </div>
            </div>
