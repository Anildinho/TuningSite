...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotroniX3">
    <div class="container">
        <h1 class="display-4 h1Class"><?= $brand ?> <?= $model ?> </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/I-modellen/bmw_iX3_variants_overview.php" class="linkDecorationNone"><?= $model ?></a></li>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">74.0 kWh</p>
                            ...
                            <p class="card-text pClass marginBottomLink">180 km/u</p>
