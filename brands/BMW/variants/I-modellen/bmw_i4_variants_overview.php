    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card" style="width: 30rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="templates/<?= $model ?>/bmw_i440_edrive_electric_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?> eDrive 40</p></a>
                    <a href="templates/<?= $model ?>/bmw_i4m50_edrive_electric_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?> M50</p></a>
                </div>
            </div>
        </div>
    </div>
