        ...
        <div class="col-md-6">
            <div class="card" style="width: 30rem; background-color: #2c3237">
                <div class="card-header" style="background-color: #212529">
                    <h5 class="card-title h5Class" style="font-weight: bold;">Elektrisch</h5>
                </div>
                <div class="card-body">
                    <a href="templates/<?= $model ?>/bmw_ix40_xdrive_electric_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?> xDrive 40</p></a>
                    <a href="templates/<?= $model ?>/bmw_ix50_xdrive_electric_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?> xDrive 50</p></a>
                </div>
            </div>
        </div>
    </div>
