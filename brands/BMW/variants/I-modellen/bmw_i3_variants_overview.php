    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card" style="width: 30rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="templates/<?= $model ?>/bmw_i3_sdrive_electric_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?> (120Ah)</p></a>
                    <a href="templates/<?= $model ?>/bmw_i3s_sdrive_electric_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?>s (120Ah)</p></a>
                </div>
            </div>
        </div>
    </div>
