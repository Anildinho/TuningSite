...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronx3m">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X3 M Competition SUV </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/X-modellen/bmw_x3_variants_overview.php" class="linkDecorationNone">X3</a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X3 M Competition SUV</a></li>
        </ol>
    </nav>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/x3m_front.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/x3m_side.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/x3m_back.jpg" class="d-block w-100" alt="...">
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">X3 M Competition</p>
                            <p class="card-text pClass marginBottomLink">SUV</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">510 pk</p>
                            <p class="card-text pClass marginBottomLink">620 nm</p>
                            <p class="card-text pClass marginBottomLink">2.998cm3</p>
                            <p class="card-text pClass marginBottomLink">6 cilinders</p>
                            ...
                            <p class="card-text pClass marginBottomLink">250 km/u</p>
