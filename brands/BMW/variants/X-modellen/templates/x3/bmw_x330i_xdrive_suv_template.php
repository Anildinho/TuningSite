...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronx3">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X3 xDrive 30i SUV </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X3 xDrive 30i SUV</a></li>
        </ol>
    </nav>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/x3_front.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/x3_side.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/x3_back.jpg" class="d-block w-100" alt="...">
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">X3 xDrive 30i</p>
                            <p class="card-text pClass marginBottomLink">SUV</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">245 pk</p>
                            <p class="card-text pClass marginBottomLink">350 nm</p>
                            <p class="card-text pClass marginBottomLink">1.998cm3</p>
                            <p class="card-text pClass marginBottomLink">4 cilinders</p>
                            ...
                            <p class="card-text pClass marginBottomLink">235 km/u</p>
                            <p class="card-text pClass marginBottomLink">6.6 sec</p>
                        </div>
                    </div>
                </div>
            </div>
