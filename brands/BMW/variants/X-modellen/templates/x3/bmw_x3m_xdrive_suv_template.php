...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronx3m">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X3 M SUV </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X3 M SUV</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">X3 M</p>
