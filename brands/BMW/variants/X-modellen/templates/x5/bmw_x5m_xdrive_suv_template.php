...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronx5m">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X5 M SUV </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X5 M SUV</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">X5 M</p>
                            <p class="card-text pClass marginBottomLink">SUV</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">600 pk</p>
