...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronx5">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X5 xDrive 25d SUV </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X5 xDrive 25d SUV</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">X5 xDrive 25d</p>
                            <p class="card-text pClass marginBottomLink">SUV</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">231 pk</p>
                            <p class="card-text pClass marginBottomLink">450 nm</p>
                            <p class="card-text pClass marginBottomLink">1.995cm3</p>
                            ...
                            <p class="card-text pClass marginBottomLink">222 km/u</p>
                            <p class="card-text pClass marginBottomLink">7.5 sec</p>
                        </div>
                    </div>
                </div>
            </div>
