...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronx5">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X5 xDrive 40i SUV </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X5 xDrive 40i SUV</a></li>
        </ol>
    </nav>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/x5_front.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/x5_side.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/x5_back.jpg" class="d-block w-100" alt="...">
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">X5 xDrive 40i</p>
                            <p class="card-text pClass marginBottomLink">SUV</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">333 pk</p>
                            <p class="card-text pClass marginBottomLink">450 nm</p>
                            ...
                            <p class="card-text pClass marginBottomLink">243 km/u</p>
