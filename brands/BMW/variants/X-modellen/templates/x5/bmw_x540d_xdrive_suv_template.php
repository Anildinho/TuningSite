...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronx5">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X5 xDrive 40d SUV </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X5 xDrive 40d SUV</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">X5 xDrive 40d</p>
                            ...
                            <p class="card-text pClass marginBottomLink">700 nm</p>
                            <p class="card-text pClass marginBottomLink">2.993cm3</p>
                            <p class="card-text pClass marginBottomLink">6 cilinders</p>
                            <p class="card-text pClass marginBottomLink">Diesel</p>
                            <p class="card-text pClass marginBottomLink">Automaat</p>
                            <p class="card-text pClass marginBottomLink">4/5 deuren</p>
                            <p class="card-text pClass marginBottomLink">245 km/u</p>
                            <p class="card-text pClass marginBottomLink">5.5 sec</p>
                        </div>
                    </div>
                </div>
            </div>
