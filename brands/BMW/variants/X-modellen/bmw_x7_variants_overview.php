...
<div class="jumbotron jumbotron2 jumbotron-fluid">
    <div class="container">
        <h1 class="display-4 h1Class">BMW X7</h1>
...
<div class="container" style="margin-bottom: 25px; margin-top: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">X7</a></li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card" style="width: 25rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="templates/x7/bmw_x740i_xdrive_suv_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">X7 xDrive 40i</p></a>
                    <a href="templates/x7/bmw_x7m50i_xdrive_suv_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">X7 M50i</p></a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card" style="width: 25rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="templates/x7/bmw_x740d_xdrive_suv_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">X7 xDrive 40d</p></a>
                </div>
            </div>
        </div>
    </div>
