    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card" style="width: 30rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="templates/<?= $model ?>/bmw_m3_sedan_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?></p></a>
                    <a href="templates/<?= $model ?>/bmw_m3c_sedan_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?> Competition</p></a>
                    <a href="templates/<?= $model ?>/bmw_m3c_xdrive_sedan_template.php" class="linkDecorationNone"><p class="card-text pClass marginBottomLink"><?= $model ?> Competition xDrive</p></a>
                </div>
            </div>
        </div>
    </div>
