...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronm2">
    <div class="container">
        <h1 class="display-4 h1Class">BMW M2 </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/M-modellen/bmw_m2_variants_overview.php" class="linkDecorationNone">M2</a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">M2</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">M2</p>
                            <p class="card-text pClass marginBottomLink">Coupe</p>
                            <p class="card-text pClass marginBottomLink">2023</p>
                            <p class="card-text pClass marginBottomLink">460 pk</p>
                            <p class="card-text pClass marginBottomLink">550 nm</p>
                            <p class="card-text pClass marginBottomLink">2.979cm3</p>
                            ...
                            <p class="card-text pClass marginBottomLink">4.1 sec</p>
                        </div>
                    </div>
                </div>
            </div>
