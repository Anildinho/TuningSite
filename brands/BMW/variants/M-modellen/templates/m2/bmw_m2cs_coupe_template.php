...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronm2">
    <div class="container">
        <h1 class="display-4 h1Class">BMW M2 CS </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">M2 CS</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">M2 CS</p>
                            <p class="card-text pClass marginBottomLink">Coupe</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">450 pk</p>
                            ...
                            <p class="card-text pClass marginBottomLink">280 km/u</p>
