...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotronm4">
    <div class="container">
        <h1 class="display-4 h1Class">BMW M4</h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/M-modellen/bmw_m4_variants_overview.php" class="linkDecorationNone">M4</a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">M4</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">M4</p>
