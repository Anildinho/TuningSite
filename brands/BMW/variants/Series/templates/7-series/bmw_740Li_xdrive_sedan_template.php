...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron7serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 7 Serie 740Li xDrive Sedan </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">740Li xDrive Sedan</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">740Li xDrive</p>
