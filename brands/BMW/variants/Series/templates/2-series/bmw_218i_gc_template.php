...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron2serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 2 Serie 218i </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">218i</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">218i</p>
                            <p class="card-text pClass marginBottomLink">Gran Coupe</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">136 pk</p>
                            <p class="card-text pClass marginBottomLink">220 nm</p>
