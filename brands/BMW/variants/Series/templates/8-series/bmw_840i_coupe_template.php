...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron8serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 8 Serie 840i Coupe </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">840i Coupe</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">840i</p>
                            ...
                            <p class="card-text pClass marginBottomLink">5.2 sec</p>
                        </div>
                    </div>
                </div>
            </div>
