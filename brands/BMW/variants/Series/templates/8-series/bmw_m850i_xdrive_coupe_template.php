...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron8serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 8 Serie M850i xDrive Coupe </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/Series/bmw_8series_variants_overview.php" class="linkDecorationNone">8 Serie</a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">M850i xDrive Coupe</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">M850i xDrive</p>
