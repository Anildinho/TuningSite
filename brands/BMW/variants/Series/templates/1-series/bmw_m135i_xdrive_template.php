...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron1serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 1 Serie M135i xDrive </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/Series/bmw_1series_variants_overview.php" class="linkDecorationNone">1 Serie</a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">M135i xDrive</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">M135i xDrive</p>
