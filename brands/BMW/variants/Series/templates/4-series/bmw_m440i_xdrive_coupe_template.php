...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron4serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 4 Serie M440i xDrive Coupe </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/BMW/variants/Series/bmw_4series_variants_overview.php" class="linkDecorationNone">4 Serie</a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">M440i xDrive Coupe</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">M440i xDrive</p>
                            <p class="card-text pClass marginBottomLink">Coupe</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">374 pk</p>
                            ...
                            <p class="card-text pClass marginBottomLink">4.5 sec</p>
                        </div>
                    </div>
                </div>
            </div>
