...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron3serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 3 Serie 318d Sedan </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">318d Sedan</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">318d</p>
                            ...
                            <p class="card-text pClass marginBottomLink">224 km/u</p>
                            <p class="card-text pClass marginBottomLink">8.2 sec</p>
                        </div>
                    </div>
                </div>
            </div>
