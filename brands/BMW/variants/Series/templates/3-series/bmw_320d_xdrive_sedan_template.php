...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotron3serie">
    <div class="container">
        <h1 class="display-4 h1Class">BMW 3 Serie 320d xDrive Sedan </h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">320d xDrive Sedan</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink">320d xDrive</p>
                            ...
                            <p class="card-text pClass marginBottomLink">233 km/u</p>
                            <p class="card-text pClass marginBottomLink">6.8 sec</p>
                        </div>
                    </div>
                </div>
            </div>
