...
<div class="jumbotron jumbotron2 jumbotron-fluid">
    <div class="container">
        <h1 class="display-4 h1Class">Audi TT RS Coupe</h1>
...
<div class="container" style="margin-bottom: 50px; margin-top: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">TT RS Coupe</a></li>
        </ol>
    </nav>
        ...
        <div class="col">
            <div class="card" style="width: 30rem; background-color: #2c3237">
                <div class="card-header" style="background-color: #212529">
                    <h5 class="card-title h5Class" style="font-weight: bold;">TT RS Coupe</h5>
                </div>
                <div class="card-body">
