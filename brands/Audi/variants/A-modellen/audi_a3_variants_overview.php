...
<div class="jumbotron jumbotron2 jumbotron-fluid">
    <div class="container">
        <h1 class="display-4 h1Class">Audi A3</h1>
...
<div class="container" style="margin-bottom: 50px; margin-top: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite">A3</a></li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col">
            <div class="card" style="width: 20rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Pro Line 30 TFSI 6-bak</p></a>
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Pro Line 30 TFSI S tronic</p></a>
                    ...
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Pro Line 30 TDI 6 bak</p></a>
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Pro Line 30 TDI S tronic</p></a>
        ...
        <div class="col">
            <div class="card" style="width: 20rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Advance Edition 30 TFSI 6-bak</p></a>
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Advance Edition 30 TFSI S tronic</p></a>
                    ...
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Advance Edition 30 TDI 6 bak</p></a>
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">Advance Edition 30 TDI S tronic</p></a>
        ...
        <div class="col">
            <div class="card" style="width: 20rem; background-color: #2c3237">
                ...
                <div class="card-body">
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">S Edition 30 TFSI 6-bak</p></a>
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">S Edition 30 TFSI S tronic</p></a>
                    ...
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">S Edition 30 TDI 6 bak</p></a>
                    <a href="#" class="linkDecorationNone"><p class="card-text pClass marginBottomLink">S Edition 30 TDI S tronic</p></a>
