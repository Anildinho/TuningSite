...
$brand = "Audi";
$modal = "A1";
$variant = "Pro Line 25 TFSI 5-bak";
...
<div class="jumbotron jumbotronTemplate jumbotron-fluid jumbotrona1">
    <div class="container">
        <h1 class="display-4 h1Class"><?=$brand?> <?=$modal?> <?=$variant?></h1>
...
<div class="container" style="margin-bottom: 25px;">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../../../../../../brands/Audi/audi_overview.php" class="linkDecorationNone"><?=$brand?></a></li>
            <li class="breadcrumb-item"><a href="../../../../../../brands/Audi/variants/A-modellen/audi_a1_variants_overview.php" class="linkDecorationNone"><?=$modal?></a></li>
            <li class="breadcrumb-item active inactiveLink" aria-current="page"><a href="#" class="linkDecorationNoneWhite"><?=$variant?></a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="card-text pClass marginBottomLink"><?=$modal?></p>
                            <p class="card-text pClass marginBottomLink">Hatchback</p>
                            <p class="card-text pClass marginBottomLink">2021</p>
                            <p class="card-text pClass marginBottomLink">95 pk</p>
                            <p class="card-text pClass marginBottomLink">175 nm</p>
                            <p class="card-text pClass marginBottomLink">0.999cm3</p>
                            <p class="card-text pClass marginBottomLink">3 cilinder</p>
                            <p class="card-text pClass marginBottomLink">Benzine</p>
                            <p class="card-text pClass marginBottomLink">Handbak 5v</p>
                            <p class="card-text pClass marginBottomLink">4/5 deuren</p>
                            <p class="card-text pClass marginBottomLink">193 km/u</p>
                            <p class="card-text pClass marginBottomLink">11 sec</p>
                        </div>
                    </div>
                </div>
            </div>
